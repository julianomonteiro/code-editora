...
<?php echo Html::openFormGroup('user_id', $errors); ?>
...
<?php echo Html::openFormGroup(['categories', 'categories.*'], $errors); ?>

<?php echo Form::label('categories[]', 'Categorias', ['class' => 'control-label']); ?>

<?php echo Form::select('categories[]', $categories, null, ['class'=>'form-control', 'multiple' => true]); ?>

<?php echo Form::error("categories", $errors); ?>
